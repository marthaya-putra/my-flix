...
CREATE INDEX "user_watchlist_watch_list_id_idx" ON "user_watchlist" USING btree ("watch_list_id");--> statement-breakpoint
CREATE INDEX "user_watchlist_category_idx" ON "user_watchlist" USING btree ("category");--> statement-breakpoint
CREATE UNIQUE INDEX "user_watchlist_user_id_watch_list_id_unique" ON "user_watchlist" USING btree ("user_id","watch_list_id");